...
const arrayOfPeople = [
  { name: 'Issam', age: 23, favoriteFoods: ['couscous', 'briwa'] },
  { name: 'Ayoub', age: 26, favoriteFoods: ['shawarma', 'pizz 4 saison'] },
  { name: 'Frank', age: 30, favoriteFoods: ['spaghetti', 'rfisa'] }
];
